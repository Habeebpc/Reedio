...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'podcast_app/templates')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'podcast_app.wsgi.application'
...
if ENVIRONMENT == 'dev':
    from podcast_app.envs.dev import *
elif ENVIRONMENT == 'prod':
    from podcast_app.envs.production import *
